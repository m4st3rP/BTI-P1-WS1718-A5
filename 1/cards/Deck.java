...
@ClassPreamble (
    ...
    date            = "2012/11/19",
    version         = "2.4",
    note            = "release for SS17 ;  1st release WS07/08",
...
public class Deck{
    ...
    @ChunkPreamble ( lastModified="2012/02/12", lastModifiedBy="Michael Schaefers" ) private List<Card> pack1st;
    @ChunkPreamble ( lastModified="2012/02/12", lastModifiedBy="Michael Schaefers" ) private List<Card> pack2nd;
    ...
    public Deck(){
        ...
        for (Constructor<?> constructor : Card.class.getDeclaredConstructors()){
            if (0!=constructor.getModifiers()){
                throw new IllegalStateException( String.format( "You have have done strange disturbing things - please call Michael Sch�fers" ) );
            }//if
        }//for
